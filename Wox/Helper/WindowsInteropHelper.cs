namespace Wox.Helper
{
    ...
    public class WindowsInteropHelper
    {
        ...
        private static IntPtr HWND_DESKTOP => _hwnd_desktop != IntPtr.Zero ? _hwnd_desktop : _hwnd_desktop = GetDesktopWindow();
            ...
            if (hWnd != null && !hWnd.Equals(IntPtr.Zero))
                ...
                if (!(hWnd.Equals(HWND_DESKTOP) || hWnd.Equals(HWND_SHELL)))
                {
                    ...
                    if (windowClass == WINDOW_CLASS_PROGMAN || windowClass == WINDOW_CLASS_WORKERW)
                    {
                        ...
                        if (hWndDesktop != null && !hWndDesktop.Equals(IntPtr.Zero)) return false;
                    }

                    var screenBounds = Screen.FromHandle(hWnd).Bounds;
                    if (appBounds.Bottom - appBounds.Top == screenBounds.Height && appBounds.Right - appBounds.Left == screenBounds.Width) return true;
                }
